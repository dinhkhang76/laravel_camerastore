 ...
 <div class="content-wrapper">
     <div class="content-header">
         <div class="container-fluid">
             <div class="row mb-2">
                 <div class="col-sm-6">
                     <h1 class="m-0 font-weight-bold text-danger">THÊM NHÀ CUNG CẤP</h1>
                 </div>            
                 ...
                 <div class="row">
                     <div class="col-md-9">
                         ...
                         <div class="form-group">
                             ...
                             <input name="name" value="{{ old('name') }}" type="text" class="form-control" id="name" placeholder="Nhập tên nhà cung cấp">
                             @if($errors->has('name'))
                            ...
                            <div class="form-group">
                                ...
                                <input name="siteurl" value="{{ old('siteurl') }}" type="url" class="form-control" id="siteurl" placeholder="Website">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="address" value="{{ old('address') }}" type="text" class="form-control" id="address" placeholder="Nhập địa chỉ">
                     ...
                     <div class="col-md-3">
                        ...
                        <div class="form-group">
                            ...
                            <input name="fullname" value="{{ old('fullname') }}" type="text" class="form-control" id="fullname" placeholder="Nhập tên người đại diện">
                        ...
                        <div class="form-group">
                            ...
                            <input name="email" value="{{ old('email') }}" type="email" class="form-control" id="email" placeholder="Nhập Email">
                            @if($errors->has('email'))
