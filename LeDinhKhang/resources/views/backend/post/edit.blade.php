...
<form name="form1" action="{{ route('post.update', ['post'=>$post->id]) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
                 ...
                 <div class="row">
                     <div class="col-md-9">
                         <div class="form-group">
                             ...
                             <input name="title" value="{{ old('title',$post->title) }}" type="text" class="form-control" id="title" placeholder="Nhập tiêu đề bài viết">
                             @if($errors->has('title'))
                         ...
                         <div class ="form-group">
                            ...
                            <textarea name="detail" rows="3" class="form-control" id="detail" placeholder="Chi tiết">{{ old('detail',$post->detail) }}</textarea>
                         ...
                         <div class ="form-group">
                             ...
                             <textarea name="metadesc" rows="3" class="form-control" id="metadesc" placeholder="Mô tả">{{ old('metadesc',$post->metadesc) }}</textarea>
                         ...
                         <div class ="form-group">
                            ...
                            <textarea name="metakey" rows="3" class="form-control" id="metakey" placeholder="Từ khóa">{{ old('metakey',$post->metakey) }}</textarea>
                     ...
                     <div class="col-md-3">
                         <div class="form-group">
                            <label for="topid">Danh mục bài viết</label>
