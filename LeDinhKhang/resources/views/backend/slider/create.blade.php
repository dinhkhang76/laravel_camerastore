 ...
 <div class="content-wrapper">
     <div class="content-header">
         <div class="container-fluid">
             <div class="row mb-2">
                 <div class="col-sm-6">
                     <h1 class="m-0 font-weight-bold text-danger">THÊM SLIDER</h1>
                 </div>            
                 ...
                 <div class="row">
                     <div class="col-md-9">
                         ...
                         <div class="form-group">
                             ...
                             <input name="name" value="{{ old('name') }}" type="text" class="form-control" id="name" placeholder="Nhập tên slider">
                             @if($errors->has('name'))
                            ...
                            <div class="form-group">
                                ...
                                <input name="url" value="{{ old('url') }}" type="url" class="form-control" id="url" placeholder="URL">
                                @if($errors->has('url'))
