            ...
            <table class="table table-striped table-bordered" id="myTable">
                ...
                <tbody> 
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            @if($row->status==1)
                            <a href="{{ route('page.status',['id'=>$row->id]) }}" class="btn btn-sm btn-success"><i class="fas fa-toggle-on"></i> </a>
                            @else
                            <a href="{{ route('page.status',['id'=>$row->id]) }}" class="btn btn-sm btn-danger"><i class="fas fa-toggle-off"></i> </a>
                            @endif
                            <a href="{{ route('page.show',['page'=>$row->id]) }}" class="btn btn-sm btn-info"><i class="fas fa-eye"></i> </a>
                            <a href="{{ route('page.edit',['page'=>$row->id]) }}" class="btn btn-sm btn-success"><i class="fas fa-edit"></i></a>
