 ...
 <div class="content-wrapper">
     <div class="content-header">
         <div class="container-fluid">
             <div class="row mb-2">
                 <div class="col-sm-6">
                     <h1 class="m-0 font-weight-bold text-danger">CẬP NHẬT TRANG ĐƠN</h1>
                 </div>            
                 ...
                 <div class="row">
                     <div class="col-md-9">
                         <div class="form-group">
                             ...
                             <input name="title" value="{{ old('title',$post->title) }}" type="text" class="form-control" id="title" placeholder="Nhập tiêu đề trang đơn">
                             @if($errors->has('title'))
