...
@section('maincontent')
    ...
    <div class="col-md-4 col-lg-9">   
        <div class="container">
          <br><br><h1 class="text-uppercase text-center"style="color:red;margin-left: 80px">TẤT CẢ BÀI VIẾT</h1><br>
                  ...
                  <div class="row">
                    <div class="col-md-3">
                      <a href="{{ route('site.slug', ['slug'=>$post->slug]) }}">
                        <img class="card-img-top img-fluid img-thumbnail rounded-circle bg-info" style="width: 250px;height:180px" src="{{ asset('images/posts/' . $post->img) }}"  alt="{{ $post->title }}"><br>                      </a>
                    </div>
                    <div class="col-md-9 ">
